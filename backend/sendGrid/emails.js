...
export const sendVerificationEmail = async (email, verificationToken) => {
  ...
  const msg = {
    to: email,
    from: "samvaarv.vid@gmail.com", // Use your SendGrid verified sender email
...
export const sendWelcomeEmail = async (email, name) => {
  const msg = {
    ...
    from: "samvaarv.vid@gmail.com", // Use your verified sender email
